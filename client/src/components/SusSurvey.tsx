 ...
 * استخدام البرنامج تقييمًا علميًا قابلًا للاستشهاد به بحثيًا، بدل تقييم
 * نجوم بسيط بلا أساس.
 */
const ITEMS = [
  "أَعْتَقِدُ أَنَّنِي سَأَرْغَبُ فِي اسْتِخْدَامِ هَذَا الْبَرْنَامَجِ بِشَكْلٍ مُتَكَرِّرٍ.",
  "وَجَدْتُ أَنَّ هَذَا الْبَرْنَامَجَ مُعَقَّدٌ أَكْثَرَ مِنَ اللَّازِمِ.",
  "اعْتَقَدْتُ أَنَّ الْبَرْنَامَجَ سَهْلُ الِاسْتِخْدَامِ.",
  "أَعْتَقِدُ أَنَّنِي سَأَحْتَاجُ إِلَى مُسَاعَدَةِ شَخْصٍ آخَرَ لِأَتَمَكَّنَ مِنِ اسْتِخْدَامِ هَذَا الْبَرْنَامَجِ.",
  "وَجَدْتُ أَنَّ الْوَظَائِفَ الْمُخْتَلِفَةَ فِي هَذَا الْبَرْنَامَجِ مُتَكَامِلَةٌ بِشَكْلٍ جَيِّدٍ.",
  "اعْتَقَدْتُ أَنَّ هُنَاكَ الْكَثِيرَ مِنَ التَّنَاقُضِ (عَدَمِ الِاتِّسَاقِ) فِي هَذَا الْبَرْنَامَجِ.",
  "أَتَخَيَّلُ أَنَّ مُعْظَمَ الطُّلَّابِ سَيَتَعَلَّمُونَ اسْتِخْدَامَ هَذَا الْبَرْنَامَجِ بِسُرْعَةٍ كَبِيرَةٍ.",
  "وَجَدْتُ أَنَّ الْبَرْنَامَجَ مُرْهِقٌ (ثَقِيلٌ) فِي الِاسْتِخْدَامِ.",
  "شَعَرْتُ بِثِقَةٍ كَبِيرَةٍ أَثْنَاءَ اسْتِخْدَامِ الْبَرْنَامَجِ.",
  "احْتَجْتُ إِلَى تَعَلُّمِ أَشْيَاءَ كَثِيرَةٍ قَبْلَ أَنْ أَتَمَكَّنَ مِنْ مُتَابَعَةِ اسْتِخْدَامِ هَذَا الْبَرْنَامَجِ.",
];
        ...
        {result ? (
          ...
          <>
            <h2 className="text-center font-bold text-lg mb-1" style={{ color: "#1a5c2a", fontFamily: "'Amiri', serif" }}>
              📋 قَيِّمْ تَجْرِبَتَكَ مَعَ الْبَرْنَامَجِ
            </h2>
            <p className="text-center text-gray-400 text-xs mb-4">
              استبيان قابلية الاستخدام (10 عبارات) — إجاباتك تُستخدَم لتطوير البرنامج بحثيًا
            </p>
